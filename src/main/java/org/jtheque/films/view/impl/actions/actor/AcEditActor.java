 ...
 */
public final class AcEditActor extends JThequeAction {
    /**
     * Construct a new AcEditActor.
     */
    public AcEditActor() {
    ...
    public void actionPerformed(ActionEvent event) {
        Managers.getManager(IBeansManager.class).<IActorController>getBean("actorController").manualEdit();
    }
}
