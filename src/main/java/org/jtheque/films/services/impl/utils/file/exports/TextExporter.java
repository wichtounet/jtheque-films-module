 ...
 */
public final class TextExporter extends AbstractExporter<Film> {
    @Override
    ...
    public void export(String path) {
        try {
            JasperDesign jasperDesign = JRXmlLoader.load(getClass().getClassLoader().getResourceAsStream(Report.FORM001_TEXT));
            ...
            textExporter.setParameter(JRExporterParameter.OUTPUT_FILE_NAME, path);
            textExporter.setParameter(JRTextExporterParameter.CHARACTER_WIDTH, 10);
            textExporter.setParameter(JRTextExporterParameter.CHARACTER_HEIGHT, 10);
